    ...
    <footer className="bg-white border-t border-slate-200 py-12 mt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-slate-500 text-sm leading-relaxed max-w-xs">
              Empowering curiosity by revealing the hidden science inside everyday electronics. Powered by Gemini 2.5 Flash.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-600">
              ...
              <li><a href="#" className="hover:text-indigo-600 transition-colors">Gallery</a></li>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-8 h-8 bg-slate-100 rounded-full flex items-center justify-center text-slate-500 hover:bg-indigo-100 hover:text-indigo-600 transition-colors">
        ...
        <div className="mt-8 pt-8 border-t border-slate-100 text-center text-slate-400 text-sm">
          &copy; {new Date().getFullYear()} ElectroSchematic AI. All rights reserved.
        </div>
      </div>
    </footer>
  );
